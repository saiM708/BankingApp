...
- **GUI Interface**: User-friendly graphical interface using Java Swing
...
7. **Delete Account**: Enter account number to delete the account
...
1. Update the email credentials in `Bank.java`:
...
- The system uses Java Swing for the GUI
